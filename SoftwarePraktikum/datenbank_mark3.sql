...
CREATE TABLE `frage_antwortmoeglichkeiten` (
  `frage_id` int(11) DEFAULT NULL,
  `antwortmoeglichkeiten` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `frage_loesung` (
  `frage_id` int(11) DEFAULT NULL,
  `loesung` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-07-12 18:11:07
